...
function NewUpdateQueue()
    ...
    function queue:newUpdate(updateType, x, y, z, blockID, meta, delay)
        if updateType ~= UPDATE_SET and updateType ~= UPDATE_DIG and updateType ~= UPDATE_SIGN then
